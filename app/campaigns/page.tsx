    ...
    <div className="p-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[#6B6B6B]">
              Manage campaigns, budgets, and Meta Ads integration
            </p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center bg-gray-100 p-1 rounded-lg">
              <Button
                ...
                className={`px-3 py-2 ${viewMode === "grid" ? "bg-white shadow-sm" : "hover:bg-gray-200"}`}
              >
        ...
        >
          <Card className="border-l-4 border-l-[#1976D2]">
            <CardContent className="p-3">
              ...
              <h3 className="text-lg font-bold text-[#1A1A1A]">
                {
                  enhancedCampaigns.filter(
                    (c) => c.metaAds?.status === "active",
                  ).length
                }
              </h3>
        ...
        >
          <Card className="border-l-4 border-l-[#FFA500]">
            <CardContent className="p-3">
              ...
              <h3 className="text-lg font-bold text-[#1A1A1A]">
                {(
                  enhancedCampaigns.reduce(
                    (sum, c) => sum + (c.metaAds?.ctr || 0),
                    0,
      ...
      {viewMode === "grid" ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {enhancedCampaigns.map((campaign, index) => {
            ...
            return (
              ...
              >
                <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-[#6A5ACD] h-full">
        ...
        <div className="grid gap-4">
          {enhancedCampaigns.map((campaign, index) => {
            const progress = (campaign.raised / campaign.goal) * 100;
            const adSpendProgress = campaign.adBudget
              ? (campaign.adBudget.spent / campaign.adBudget.total) * 100
              : 0;
                        ...
                        <div>
                          ...
                          <div className="w-full bg-gray-100 rounded-full h-1 mt-1">
                            <div
                              ...
                              style={{
                                width: `${Math.min(adSpendProgress, 100)}%`,
                              }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              $
                              {(
                                selectedCampaign.goal - selectedCampaign.raised
                              ).toLocaleString()}{" "}
                              remaining
                            </span>
                          </div>
                      ...
                      <Card>
                        <CardHeader>
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              size="sm"
                              onClick={() => setShowMetaAdsDrawer(true)}
                            >
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="text-center mb-4">
                            ...
                            <p className="text-sm text-[#6B6B6B]">
                              of $
                              {selectedCampaign.adBudget.total.toLocaleString()}
                            </p>
                          </div>
                          ...
                          <div className="w-full bg-gray-100 rounded-full h-3 mb-4 overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${Math.min((selectedCampaign.adBudget.spent / selectedCampaign.adBudget.total) * 100, 100)}%`,
                              }}
                            />
                          </div>
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                $
                                {(selectedCampaign.adBudget.spent / 30).toFixed(
                                  2,
                                )}
                              </span>
                            </div>
                            <div className="flex justify-between">
                              ...
                              <span className="font-medium">
                                $
                                {(
                                  selectedCampaign.adBudget.total -
                                  selectedCampaign.adBudget.spent
                                ).toLocaleString()}
                              </span>
                            </div>
                            <div className="flex justify-between">
                        ...
                        <CardContent>
                          ...
                          <div className="space-y-3">
                            <div>
                              ...
                              <p className="font-medium text-[#1A1A1A]">
                                {selectedCampaign.location.city},{" "}
                                {selectedCampaign.location.state}
                              </p>
                              <p className="text-sm text-[#6B6B6B]">
                                {selectedCampaign.location.country}
                              </p>
                            </div>
